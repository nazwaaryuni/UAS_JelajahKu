                ...
                <div class="col-md-9">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-default @error('role') is-invalid  @enderror" id="role"
                            ...
                            <option value="admin" @selected(old('role', $user->role) == 'admin')>Admin IT</option>
                            <option value="principal" @selected(old('role', $user->role) == 'principal')>Kepala Sekolah</option>
                            ...
                            <option value="parent" @selected(old('role', $user->role) == 'parent')>Orang Tua</option>
                        </select>
                        @error('role')
                            <div class="invalid-feedback">
                                {{ $message }}
